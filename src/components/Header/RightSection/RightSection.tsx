  ...
  return (
    <div className="flex items-center justify-between">
        <div className="flex items-center justify-center gap-3">
            <div className="cursor-pointer w-14 rounded-xl p-1 h-7 relative flex items-center justify-start dark:bg-blue-500 bg-[#E2E8F0]">
              <div className="rounded-[70%] absolute duration-250 transition-all shadow-lg w-[1.4rem] h-5 flex items-center justify-center p-1 bg-white">
